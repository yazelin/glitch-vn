...
b.add('d2m-quote2', {'text': '我照做。我自己也想不出別的辦法。', 'type': 'dialogue', 'title': '我照做。我自己也想不出別的辦法。', 'emotion': '開心', 'speaker': '格莉奇', 'character': 'https://pub-4b20b43f5acf4dfaa3f6ab842daa51cf.r2.dev/2d3b0242-9a6d-4051-9825-46aa4efd064a/larch/project-e14f9260-e4c0-4ce7-9d2d-70203cdec591/1787196225907_glitch-happy.webp', 'characterId': 'character-15c41e1f-ca37-424f-8c49-ac1031a42928', 'characterPosition': 'center'}, x=3300, y=0)
...
b.add('d2m-feet', {'text': '門邊那疊沒穿的短靴今天剩得比較少。\n她沒有數，她從來不數。', 'type': 'dialogue', 'title': '旁白', 'speaker': '旁白', 'characterPosition': 'center'}, x=3900, y=0)
...
b.settext("d2m-lost3", "所以我只能重問一次。有點尷尬，"
                       "不過我每天都在重問，所以也還好。")
b.find("d2m-lost3")["data"]["speaker"] = "格莉奇"   # 反推回來的時候標成黑洞先生,可是這是她的自白。他一次最多兩句短的。
