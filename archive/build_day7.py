...
rem = b.chain([
    ...
    ("d7m-r17","黑洞先生把麵包放在桌上。門關上的聲音很小。像是刻意放輕的。", "平常", None),
...
af = b.chain([
    ...
    ("d7e-af3", "黑洞先生不吃這種東西。他從來沒有吃過任何食物。", "平常", None),
    ("d7e-af4", "她第一天就告訴過你了。「他只吃被忘掉的事。」", "平常", None),
    ("d7e-af5", "你也忘了。", "平常", None),
    ("d7e-af6", "黑洞先生的內袋鼓鼓的。裡面不只這一塊。", "平常", None),
    ("d7e-af7", "她每天半夜都會烤一塊，然後在天亮之前忘掉自己烤過。", "平常", None),
    ("d7e-af8", "黑洞先生每天都收下。他從來沒有告訴格莉奇自己吃不了。", "平常", None),
...
ae = b.chain([
    ("d7e-ae1", "黑洞先生把麵包拿起來。隔著保鮮膜掂了一下。然後收進西裝內袋。", "平常", None),
    ("d7e-ae2", "黑洞先生不吃這種東西。他從來沒有吃過任何食物。", "平常", None),
    ...
    ("d7e-ae8", "黑洞先生坐進角落。他把內袋的位置按了一下。確認那塊麵包還在。", "平常", None),
    ("d7e-ae9", "黑洞先生吃不了它。可是他還是要確認它還在。", "平常", None),
    ("d7e-ae10","她醒過來。", "平常", None),
    ("d7e-ae11","你今天怎麼這麼瘦。", "平常", G),
    ("d7e-ae12","黑洞先生看著她。這個問題他可以回答。可是回答了，格莉奇明天也不會記得。", "平常", None),
    ("d7e-ae13","沒事。", "預設", HOLE),
