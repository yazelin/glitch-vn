...
line = b.add("d6n-line", {"type": "input", "title": "替她想一句話",
    "text": "她要拜託黑洞先生一件事：麵包他吃不了，可是「我送你麵包」這件事他吃得下。\n她想請他不要吃掉那一件。\n你替她想一句話。她會照著念。",
...
BR = {
 "tear": [
    ...
    ("d6e-t11","他看了她一會兒。觸手在內袋的位置輕輕按了一下。", "平常", None),
    ("d6e-t12","好。", "預設", HOLE),
 ],
 "keep": [
