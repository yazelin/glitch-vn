...
canon = b.chain([
    ("d1m-keep1", "被吃掉不是不見了喔。", "平常", G),
    ("d1m-keep2", "而且順序不是那樣。他不是從我腦子裡挖東西出來。", "平常", G),
    ("d1m-keep3", "是我先忘記，他才吃得到。", "平常", G),
    ("d1m-keep4", "我很容易分心。剛剛還在想一件事，看到別的就跑掉了。", "平常", G),
    ("d1m-keep5", "跑掉的那件就不會再回來。這種事每天都在發生。", "平常", G),
    ("d1m-keep6", "所以他每天都有東西吃。", "平常", G),
    ("d1m-keep6b","而且他說我忘掉的東西特別好吃。", "開心", G),
    ("d1m-keep6c","人也會忘記事情啊，可是人是慢慢忘的，忘到最後糊糊的一團。", "平常", G),
    ("d1m-keep6d","黑洞先生說那個只能當零食，吃不飽。", "平常", G),
    ("d1m-keep6e","我不一樣。我是清空。一次掉出來一整件，邊邊角角都在。", "平常", G),
    ("d1m-keep6f","所以他才跟我住。別人那裡他只吃得到零食。", "開心", G),
    ("d1m-keep6g","一整件要花一天才消化得完，所以他一天只吃得下一件。", "平常", G),
    ("d1m-keep7", "被黑洞先生吃掉的東西一直都在他裡面。一件都不會少。\n他是黑洞嘛。", "平常", G),
    ("d1m-keep8", "只是拿不回來。記憶進去以後就出不來了，連他自己都拿不到。", "發呆", G),
