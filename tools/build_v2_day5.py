...
b.scene("d5-open", "第五天・開播前", "直播室的倒數顯示 30:00。桌上排著麵粉、酵母、鹽、水。", "早", start=True)
b.prev = "d5-open"
...
sc = b.scene("d5-live", "第五天・直播中", "留言區開了。", "中")
...
sc2 = b.scene("d5-off", "第五天・下播後", "鏡頭朝著天花板。麥克風還開著。", "晚")
