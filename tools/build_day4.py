...
RECALL = [
    ("保鮮膜的折法",
     "「對！保鮮膜的折法！」她拍手。「先對折兩次，再從中間往外壓。對，是這個。」",
     "「保鮮膜？」她想了一下。「不是吧。我對保鮮膜沒有什麼想法。」\n她把這件事放掉了。"),
    ("窗台上的圓印",
     "「對，窗台！」她跑過去看。「圓圓的，碗底那麼大。你記得真清楚。」",
     "「窗台喔。」她走過去看了一眼。「上面沒有東西啊。」\n她把這件事放掉了。"),
    ("裂開的那雙靴子",
     "「對，那雙裂開的。」她蹲到門邊。「還在。裂痕比昨天長了一點點。」",
     "「靴子？」她看了門邊一眼。「靴子每天都在那裡，這也算一件事嗎。」\n她把這件事放掉了。"),
    ("守則上的那兩條",
     "「對，守則本！」她翻開。「『不要半夜開烤箱』、『麵粉要收在櫃子裡』。找到了。」",
     "「守則本上寫的東西我每天都看得到啊。」她說。「應該不是那個。」\n她把這件事放掉了。"),
    ("角落地板上的圓",
     "「對，角落那個圓。」她走過去蹲下來。「這麼規則，一定是坐出來的。」",
     "「角落？」她看了一眼那個方向。「那邊只有地板。」\n她把這件事放掉了。"),
]
...
EVENTS = [
    ...
    ("map", "usedMap",
     ...
     "「格莉奇盯著地圖上那個圈看了很久。明天格莉奇會忘記那個圈是誰畫的。但會記得一件事。她不知道黑洞先生每天去哪裡。這個「不知道」會跟著她。」",
