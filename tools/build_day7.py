...
af = b.chain([
    ...
    ("d7e-af2", "黑洞先生沒有解釋。他轉身進廚房，倒了一杯水。", "平常", None),
    ("d7e-af3", "門邊那疊短靴今天很高。這禮拜長出來的腳，一隻都沒有收回去。", "平常", None),
    ("d7e-af4", "她醒過來，看見他坐在對面，手裡是空杯子。", "平常", None),
    ("d7e-af5", "你回來啦。桌上那個是什麼。我烤的嗎。", "平常", G),
    ("d7e-af6", "黑洞先生沒有回答。", "平常", None),
    ("d7e-af7", "桌上那塊麵包，明天還會在那裡。保鮮膜會皺一點。後天也還會在。", "平常", None),
    ("d7e-af8", "今天的守則——不要忘記桌上的東西。", "平常", G),
    ("d7e-af9", "她寫下來，存檔，睡著。", "平常", None),
    ("d7e-af10","那塊麵包留在桌上。第二天早上她會看到它，問一次「這是什麼」，然後放著。", "平常", None),
    ("d7e-af11","第三天她會問「這放多久了」。第四天保鮮膜會開始起霧。", "平常", None),
    ("d7e-af12","黑洞先生每天回來都會經過那張桌子。他每天都會慢下來一點點。", "平常", None),
    ("d7e-af13","可是黑洞先生吃不下了。他這禮拜已經吃過太多她忘掉的東西。那些是你交給他的。", "平常", None),
    ("d7e-af14","門邊那疊短靴，是這禮拜長出來的。每一雙都對應一次她的遺忘。", "平常", None),
    ("d7e-af15","她為他烤的那一塊，是唯一一件他沒有辦法收下的。", "平常", None),
], x=ex + 620, y=-820, link_prev=False)
b.link(a_wait, af[0], "right", cond={"variable": "fedCount", "op": "gte", "value": 1})

ae = b.chain([
    ("d7e-ae1", "黑洞先生伸出一隻觸手，把保鮮膜拆開。這是這一個禮拜他第一次吃東西。", "平常", None),
    ("d7e-ae2", "黑洞先生吃得很慢。慢到她醒過來的時候還沒吃完。", "平常", None),
    ("d7e-ae3", "你在吃什麼。", "發呆", G),
    ("d7e-ae4", "妳做的。", "預設", HOLE),
    ("d7e-ae5", "我做的？我什麼時候——", "當機", G),
    ("d7e-ae6", "以前。", "預設", HOLE),
    ("d7e-ae7", "她本來要再問一次「以前是什麼時候」。她沒有問。她看著他把最後一口吃完。", "平常", None),
    ("d7e-ae8", "黑洞先生的西裝下襬動了一下。一隻新的觸手伸出來，穿著一雙誰都沒見過的短靴。", "平常", None),
    ("d7e-ae9", "今天的守則——他吃了我做的東西。他說是以前。以前的我也在。", "平常", G),
    ("d7e-ae10","她寫下來，存檔，睡著。", "平常", None),
    ("d7e-ae11","桌上只剩一張攤平的保鮮膜，和上面她自己的指紋。", "平常", None),
    ("d7e-ae12","黑洞先生坐在角落，沒有睡。他一整晚都維持同一個姿勢。", "平常", None),
    ("d7e-ae13","這禮拜你一次都沒有把她忘掉的東西交給他。他餓了七天。", "平常", None),
    ("d7e-ae14","所以他吃得下。所以他吃到了。", "平常", None),
    ("d7e-ae15","門邊那疊短靴今天沒有變高。這禮拜一次都沒有變高過。", "平常", None),
    ("d7e-ae16","天亮之前，黑洞先生從內袋拿出那張紙條。她寫的「給黑洞先生」，他沒有吃掉的那一張。", "平常", None),
    ("d7e-ae17","他把它摺好，放回口袋。這件事沒有人看見，包括你。", "平常", None),
...
cc = b.chain([
    ...
    ("d7e-c15","黑洞先生知道你拿了。他什麼都知道，他只是不說。", "平常", None),
    ("d7e-c16","黑洞先生這禮拜吃掉的每一件事都還在他裡面。他可以隨時把任何一件講出來。", "平常", None),
    ("d7e-c17","黑洞先生從來沒有講過。", "平常", None),
    ("d7e-c18","現在你也有一件了。你也可以選擇要不要講。", "平常", None),
