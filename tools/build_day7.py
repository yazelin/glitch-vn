...
b.chain([
    ...
    ("d7n-why5", "她把你的話唸了一次，然後又唸了一次，唸得很慢，像在把它裝進某個格子裡。", "平常", None),
...
af = b.chain([
    ...
    ("d7e-af12","他每天回來都會經過那張桌子。他每天都會慢下來一點點。", "平常", None),
    ("d7e-af13","可是他吃不下了。他這禮拜已經吃過太多她忘掉的東西——那些是你交給他的。", "平常", None),
...
bb = b.chain([
    ...
    ("d7e-b15","他在角落看著她睡。桌上那張保鮮膜他沒有收。", "平常", None),
...
cc = b.chain([
    ...
    ("d7e-c14","他站在桌邊看那個空掉的位置，看了很久。", "平常", None),
    ("d7e-c15","他知道你拿了。他什麼都知道，他只是不說。", "平常", None),
    ("d7e-c16","他這禮拜吃掉的每一件事都還在他裡面。他可以隨時把任何一件講出來。", "平常", None),
    ("d7e-c17","他從來沒有講過。", "平常", None),
