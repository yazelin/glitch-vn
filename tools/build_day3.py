...
b.link(b.prev, cur); b.prev = cur
# kimi 的點子。他吃的是她忘掉的東西 —— 昨天那一頁她也忘了自己寫過,所以吃得下。
# 「這味道像上週的」是全部點子裡最能深化「以前」的一個:他的胃裡時間是壓縮的,
# 所以他分不清昨天跟上週,「以前」對他不是敷衍,是他真的說不出來。
b.chain([
    ("d3e-page",  "他走過來，翻開守則本，停在昨天那一頁。", "平常", None),
    ("d3e-mayI",  "這頁。", "預設", HOLE),
    ("d3e-sure",  "喔。那頁我不記得寫了什麼，你拿去吧。", "平常", G),
    ("d3e-tear",  "他把那一頁撕下來，摺成很小一塊，放進嘴裡。", "平常", None),
    ("d3e-taste", "這味道像上週的。", "預設", HOLE),
    ("d3e-what",  "那是昨天才寫的。", "當機", G),
    ("d3e-look",  "他看著她，像在確認什麼。然後他把本子闔上。", "平常", None),
    ("d3e-same",  "一樣。", "預設", HOLE),
    ("d3e-huh",   "什麼一樣？昨天跟上週怎麼會一樣？", "發呆", G),
    ("d3e-inside","他沒有回答。她不知道在他裡面，昨天跟上週放在同一個地方。", "平常", None),
])
b.chain([
